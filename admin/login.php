	...
	<div class="container">
			...
			<div class="box-form">
				<form action="" method="post">
							...
							<td>
								<div class="jenis-user">
									...
									<label for="check-user">
										<a id="btn-view-user">Jenis User : Administrator</a>
									</label>
									<div class="box-view-user">
										<a href="../auth/login" id="btn-view-user">Pengguna</a>
									</div>
								</div>
							</td>
						</tr>
					...
					<div class="button-submit">
						...
						<form action="" method="post">
							<button id="register-mobile" onclick="return confirm('Untuk Pendaftaran Administrator Silahkan Hubungi 082346455079');">Belum Punya Akun</button>
						</form>
					</div>
		...
		<div class="content-right">
			...
			<div class="button-login">
					<form action="" method="post">
						<button onclick="return confirm('Untuk Pendaftaran Administrator Silahkan Hubungi 082346455079');">Belum Punya Akun</button>
					</form>
			</div>
		</div>
		<!-- end content right -->
